...
namespace SinunyTranslate.Utility
{
    internal class Ocr_ChineseOcrLite
    {
        ...
        {
            string detPath = "Assets\\ChineseOcr_Lite\\models\\dbnet.onnx";
            string clsPath = "Assets\\ChineseOcr_Lite\\models\\angle_net.onnx";
            string recPath = "Assets\\ChineseOcr_Lite\\models\\crnn_lite_lstm.onnx";
            string keysPath = "Assets\\ChineseOcr_Lite\\models\\keys.txt";
            int threadCount = 4;
